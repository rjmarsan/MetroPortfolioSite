...
class Project(gallery.Project):
    project_dir = '/static/projects/food/' 

    name = 'Food'  #this is the 'shortcode' name, so it needs to be safe for URLs
    tags = ['Photography']  #a list of all of the tags of your work.  be descriptive!
    title = 'Food' #the actual title of your beautiful work.  this does not need to be URL safe
